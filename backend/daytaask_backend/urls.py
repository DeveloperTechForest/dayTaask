"""
URL configuration for daytaask_backend project.
...
urlpatterns = [
    ...
    path("auth/otp/", include("auth_app.urls.otp")),
    path("google/", include("auth_app.urls.google")),
    path("api/services/", include("services_app.urls")),
    path("api/taaskr/", include("taaskr_app.urls")),
