...
export default function AllBookings() {
  ...
  const fetchBookings = async () => {
    try {
      ...
      const url = query
        ? `/api/bookings/admin/bookings/?${query}`
  ...
  // Reset page & refetch when filters change
  useEffect(() => {
    setCurrentPage(1);
    fetchBookings();
  ...
  const fetchBookingDetail = async (bookingId) => {
    ...
    try {
      ...
      const data = await apiFetch(`/api/bookings/admin/bookings/${bookingId}/`);
  ...
  return (
    <div className="space-y-7">
      ...
      {/* Bookings Table */}
      <div className="relative bg-white rounded-2xl shadow-sm border border-slate-200 mb-10">
                        ...
                        <div className="relative flex justify-end">
                          ...
                          {isOpen && (
                            ...
                            >
                              ...
                              <Link
                                href={`/bookings/allBookings/editBooking/${b.id}`}
                              >
