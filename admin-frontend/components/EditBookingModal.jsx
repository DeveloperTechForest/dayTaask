...
const mockStatuses = ["pending", "confirmed", "cancelled", "completed"];
...
export default function EditBookingModal({
  ...
  const editBookingFunc = async () => {
    try {
      ...
      await apiFetch(`/api/bookings/admin/bookings/${initialData.id}/`, {
        method: "PATCH",
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        <div className="flex-shrink-0 p-6 border-b border-slate-200 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-slate-900">
            Edit Booking {initialData.booking_code}
          </h2>
          <button
            onClick={onClose}
